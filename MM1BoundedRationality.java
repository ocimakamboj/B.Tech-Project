...
b - level of bounded rationality
...
public class MM1BoundedRationality{
	...
	double[][] SystemState; //2-dimensional array that stores the system state at each point of time; 
							...
							//this records the ordered pair whenever an event occurs, this (1,4) means system state
	...
	//ServiceParameter, the 'Reward' the customer will get on the completion of the service, the 'price' he'll pay for joining the Queue, the 
	//'Cost' incurred per unit time while staying in the queue, and the bounded rationality level 'b'
	public MM1BoundedRationality(double t, double ArrivalParameter, double ServiceParameter, double Reward, double price, double Cost, double b){	
		globalT = 0;
		nArrivals = 0;
		nDepartures = 0;
		nDepartIndex = 0;
	...
	public void PrintStats(){
		System.out.println("for MM1BoundedRationality");
