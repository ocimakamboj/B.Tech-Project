...
public class PriorityQueueBoundedRationality1{
	...
	public PriorityQueueBoundedRationality1(double t, int s, int k, double[] ArrivalParameter, double[] ServiceParameter, double[] Reward, double[] price, double[] Cost, double W, double b){
		int capacity = 20000;
		globalT = 0;
	...
	public void PrintStats(){
		System.out.println("for PriorityBoundedRationality1");
		for(int i = 1; i<=noOfClasses ; i++){ 
