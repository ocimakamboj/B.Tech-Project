...
public class PriorityQueueFullRationality2{
	...
	public PriorityQueueFullRationality2(double t, int s, int k, double[] ArrivalParameter, double[] ServiceParameter, double[] Reward, double[] price, double[] Cost){
		int capacity = 20000;
		globalT = 0;
	...
	public void PrintStats(){
		System.out.println("for PriorityQueueFullRationality2");
		for(int i = 1; i<=noOfClasses ; i++){ 
